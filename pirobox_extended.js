...
(function($) {
	...
	var close_description_link = '<div style="color: white;" class="pull-right"><i class="icon-remove" style="cursor: pointer" onclick="$(this).closest(\'.caption\').slideToggle(200);"></i></div>';
	var struct =(
	...
	function open_all(){
			...
			switch (params[0]) {
				...
				case 'gallery':
					...
					piro_capt.html(close_description_link + '<p>' + descr + '</p>');
					}
					animate_image();
				break;
